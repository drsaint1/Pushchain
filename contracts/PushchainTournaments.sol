...
contract PushchainTournaments is Ownable, ReentrancyGuard, Pausable {
    struct Tournament {
        uint256 id;
        string name;
        uint256 entryFee;
    ...
    IPushchainRacing public racingContract;
    ...
    constructor(address _racingContract) Ownable(msg.sender) {
        racingContract = IPushchainRacing(_racingContract);
    }
    ...
    function enterTournament(uint256 tournamentId, uint256 carId) external payable whenNotPaused {
        ...
        IPushchainRacing.RaceCar memory car = racingContract.getCarDetails(carId);
    ...
    function breedCars(uint256 parent1Id, uint256 parent2Id) external payable whenNotPaused {
        ...
        IPushchainRacing.RaceCar memory parent1 = racingContract.getCarDetails(parent1Id);
        IPushchainRacing.RaceCar memory parent2 = racingContract.getCarDetails(parent2Id);
