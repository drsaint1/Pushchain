...
import { usePushChainUniversal } from "./usePushChainUniversal";
    ...
    outputs: [
      {
        ...
        internalType: "struct PushchainRacing.RaceCar",
        name: "",
        type: "tuple",
      },
    ],
    ...
    outputs: [
      {
        ...
        internalType: "struct PushchainRacing.RaceResult[]",
        name: "",
        type: "tuple[]",
      },
    ],
...
export const useRacingContract = () => {
  ...
  const { getUniversalAccount, isConnected: isPushConnected, executeUniversalTransaction } = usePushChainUniversal();
  ...
  const submitRaceResult = useCallback(
    ...
    [activeAddress, writeContract, refetchCars, refetchStats]
  );
